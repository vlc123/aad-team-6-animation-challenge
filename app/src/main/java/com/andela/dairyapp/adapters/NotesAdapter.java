...
public class NotesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public static List<Note> noteListFilterOrder;
    public static List<Note> noteListFilterReverseOrder;
    private Cursor cursor;


    public NotesAdapter(List<Note> noteList) {
        this.noteList = noteList;
        noteListFilterOrder = new ArrayList<>(noteList);
        noteListFilterReverseOrder = new ArrayList<>(noteList);
    }
